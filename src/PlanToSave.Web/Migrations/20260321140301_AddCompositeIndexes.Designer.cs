...
namespace PlanToSave.Web.Migrations
{
    ...
    [Migration("20260321140301_AddCompositeIndexes")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("PlanToSave.Domain.Entities.ActivityPlan", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("PlanToSave.Domain.Entities.ActivityReview", b =>
                {
                    ...
                    b.ToTable("ActivityReviews", "plantosave");
                });

            modelBuilder.Entity("PlanToSave.Domain.Entities.ActivityStep", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("ActivitySteps", "plantosave");
                });
            ...
            modelBuilder.Entity("PlanToSave.Domain.Entities.BalanceSnapshot", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("BalanceSnapshots", "plantosave");
                });

            modelBuilder.Entity("PlanToSave.Domain.Entities.CalendarEvent", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("CalendarEvents", "plantosave");
                });
            ...
            modelBuilder.Entity("PlanToSave.Domain.Entities.Idea", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("Ideas", "plantosave");
                });

            modelBuilder.Entity("PlanToSave.Domain.Entities.InterestRule", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("InterestRules", "plantosave");
                });
            ...
            modelBuilder.Entity("PlanToSave.Domain.Entities.ActivityPlan", b =>
                {
                    b.HasOne("PlanToSave.Domain.Entities.Idea", "Idea")
            ...
            modelBuilder.Entity("PlanToSave.Domain.Entities.ActivityReview", b =>
                {
                    b.HasOne("PlanToSave.Domain.Entities.ActivityPlan", "ActivityPlan")
                        .WithOne("Review")
                        .HasForeignKey("PlanToSave.Domain.Entities.ActivityReview", "ActivityPlanId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("PlanToSave.Domain.Entities.BalanceSnapshot", b =>
                {
                    b.HasOne("PlanToSave.Domain.Entities.Account", "Account")
                        .WithMany()
